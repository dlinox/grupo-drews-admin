        ...
        <div class="card-content">
            ...
            <div class="card-descripcion">
                <div class="row">
                    ...
                    <div class="col-3">
                        <img
                            src="data:image/png;base64,"
                        />
                        <span> {{ item.capacidad }} pers.</span>
                    </div>
                    <div class="col-3">
                        <img
                    ...
                    <div class="col-3">
                        <img
                            src="data:image/png;base64,"
                        />
                        <span> {{ item.puertas }} prta.</span>
                    </div>
                </div>
            </div>
            <hr />
...
.card-vehiculo {
    ...
    &:hover {
        .shapes {
            .shape {
                background-color: rgba($app-color1, 0.08);
            }
        }
